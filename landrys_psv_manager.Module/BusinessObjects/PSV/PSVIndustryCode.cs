...
namespace landrys_psv_manager.Module.BusinessObjects.PSV
{
    ...
    public class PSVIndustryCode : BaseObject
    {
        ...
        [RuleRequiredField("RuleRequiredField for PSVIndustryCode.Name", DefaultContexts.Save)]
        [RuleUniqueValue("RuleUniqueValue for PSVIndustryCode.Name", DefaultContexts.Save)]
